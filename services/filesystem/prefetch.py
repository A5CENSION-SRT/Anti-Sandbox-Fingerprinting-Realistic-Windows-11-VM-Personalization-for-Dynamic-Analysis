...
_PROFILE_APPS: Dict[str, List[Dict[str, Any]]] = {
    "office_user": [
        ...
        {"name": "MSONENOTE.EXE",  "path": r"C:\Program Files\Microsoft Office\root\Office16\ONENOTE.EXE",  "runs": (10, 50),    "extra_dlls": _OFFICE_DLLS},
        ...
        {"name": "SKYPE.EXE",      "path": r"C:\Program Files\Microsoft\Skype for Desktop\Skype.exe",        "runs": (20, 100),   "extra_dlls": []},
        {"name": "ACROBAT.EXE",    "path": r"C:\Program Files\Adobe\Acrobat DC\Acrobat\Acrobat.exe",         "runs": (20, 80),    "extra_dlls": []},
        {"name": "ZOOM.EXE",       "path": r"C:\Users\{username}\AppData\Roaming\Zoom\bin\Zoom.exe",         "runs": (50, 200),   "extra_dlls": []},
        {"name": "SLACK.EXE",      "path": r"C:\Users\{username}\AppData\Local\slack\slack.exe",             "runs": (100, 400),  "extra_dlls": _EDGE_DLLS},
    ],
    "developer": [
        ...
        {"name": "PYTHON.EXE",          "path": r"C:\Users\{username}\AppData\Local\Programs\Python\Python311\python.exe","runs": (80, 400),   "extra_dlls": _DEV_DLLS},
        {"name": "CHROME.EXE",          "path": r"C:\Program Files\Google\Chrome\Application\chrome.exe",                 "runs": (200, 800),  "extra_dlls": _CHROME_DLLS},
        {"name": "SLACK.EXE",           "path": r"C:\Users\{username}\AppData\Local\slack\slack.exe",                    "runs": (100, 400),  "extra_dlls": _EDGE_DLLS},
        {"name": "POSTMAN.EXE",         "path": r"C:\Users\{username}\AppData\Local\Postman\Postman.exe",                 "runs": (20, 100),   "extra_dlls": []},
        {"name": "DBEAVER.EXE",         "path": r"C:\Program Files\DBeaver\dbeaver.exe",                                  "runs": (15, 80),    "extra_dlls": []},
    ],
    "home_user": [
        ...
        {"name": "DISCORD.EXE",    "path": r"C:\Users\{username}\AppData\Local\Discord\Update.exe",          "runs": (100, 400),  "extra_dlls": _EDGE_DLLS},
        {"name": "STEAM.EXE",      "path": r"C:\Program Files (x86)\Steam\steam.exe",                        "runs": (50, 300),   "extra_dlls": []},
        {"name": "WHATSAPP.EXE",   "path": r"C:\Program Files\WindowsApps\WhatsApp\WhatsApp.exe",            "runs": (80, 300),   "extra_dlls": []},
        {"name": "WINRAR.EXE",     "path": r"C:\Program Files\WinRAR\WinRAR.exe",                            "runs": (10, 50),    "extra_dlls": []},
        {"name": "PAINT.EXE",      "path": r"C:\Windows\System32\mspaint.exe",                               "runs": (5, 30),     "extra_dlls": []},
        {"name": "ZOOM.EXE",       "path": r"C:\Users\{username}\AppData\Roaming\Zoom\bin\Zoom.exe",         "runs": (30, 150),   "extra_dlls": []},
        {"name": "TEAMS.EXE",      "path": r"C:\Program Files\WindowsApps\MSTeams\ms-teams.exe",             "runs": (30, 150),   "extra_dlls": _EDGE_DLLS},
    ],
}

_COMMON_APPS: List[Dict[str, Any]] = [
    # Core Windows processes — present on every system
    ...
    # Additional universal system binaries (A11 density)
    {"name": "POWERSHELL.EXE",         "path": r"C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe",   "runs": (30, 200),   "extra_dlls": []},
    {"name": "TASKMGR.EXE",            "path": r"C:\Windows\System32\Taskmgr.exe",                             "runs": (10, 50),    "extra_dlls": []},
    {"name": "SETTINGSAPP.EXE",        "path": r"C:\Windows\ImmersiveControlPanel\SystemSettings.exe",          "runs": (20, 80),    "extra_dlls": []},
    {"name": "MSIEXEC.EXE",            "path": r"C:\Windows\System32\msiexec.exe",                             "runs": (5, 30),     "extra_dlls": []},
    {"name": "BACKGROUNDTASKHOST.EXE", "path": r"C:\Windows\System32\backgroundTaskHost.exe",                  "runs": (50, 300),   "extra_dlls": []},
    {"name": "CONHOST.EXE",            "path": r"C:\Windows\System32\conhost.exe",                             "runs": (30, 200),   "extra_dlls": []},
    {"name": "SIHOST.EXE",             "path": r"C:\Windows\System32\sihost.exe",                              "runs": (100, 400),  "extra_dlls": []},
    {"name": "CTFMON.EXE",             "path": r"C:\Windows\System32\ctfmon.exe",                              "runs": (100, 400),  "extra_dlls": []},
    {"name": "WINLOGON.EXE",           "path": r"C:\Windows\System32\winlogon.exe",                            "runs": (20, 100),   "extra_dlls": []},
    {"name": "FONTDRVHOST.EXE",        "path": r"C:\Windows\System32\fontdrvhost.exe",                         "runs": (50, 200),   "extra_dlls": []},
    {"name": "AUDIODG.EXE",            "path": r"C:\Windows\System32\audiodg.exe",                             "runs": (50, 200),   "extra_dlls": []},
    {"name": "DWMAPI.EXE",             "path": r"C:\Windows\System32\dwm.exe",                                 "runs": (20, 100),   "extra_dlls": []},
    {"name": "SEARCHINDEXER.EXE",      "path": r"C:\Windows\System32\SearchIndexer.exe",                       "runs": (20, 80),    "extra_dlls": []},
    {"name": "ONEDRIVE.EXE",           "path": r"C:\Program Files\Microsoft OneDrive\OneDrive.exe",            "runs": (50, 200),   "extra_dlls": []},
    {"name": "MSEDGE.EXE",             "path": r"C:\Program Files (x86)\Microsoft\Edge\Application\msedge.exe","runs": (100, 500),  "extra_dlls": _EDGE_DLLS},
]
